...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.myRequest = void 0;var BASE_URL = 'http://152.136.185.210:7878/api/m5';
...
var _getters = _interopRequireDefault(__webpack_require__(/*! ./getters.js */ 17));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
_mutationTypes.ADD_TO_CART, function (state, payload) {
  state.cartList.push(payload);
}), _defineProperty(_ADD_TO_CART$ADD_COUN,

_mutationTypes.ADD_COUNT, function (state, payload) {
  payload[0].count += payload[1];
}), _defineProperty(_ADD_TO_CART$ADD_COUN,

_mutationTypes.CHANGE_SELECTED, function (state, payload) {
  payload.isActived = !payload.isActived;
}), _defineProperty(_ADD_TO_CART$ADD_COUN,

_mutationTypes.CHANGE_COUNT, function (state, payload) {
  payload[0].count = payload[1];
}), _defineProperty(_ADD_TO_CART$ADD_COUN,

_mutationTypes.DELETE_GOOD, function (state) {
  state.cartList = state.cartList.filter(function (item) {
    return item.isActived == false;
  });
}), _defineProperty(_ADD_TO_CART$ADD_COUN,

_mutationTypes.COLLECT_GOOD, function (state, payload) {
  state.collList.push(payload);
}), _defineProperty(_ADD_TO_CART$ADD_COUN,

_mutationTypes.DEL_COLLECT, function (state) {
  state.collList = state.collList.filter(function (item) {
    return item.isSelect == false;
  });
}), _defineProperty(_ADD_TO_CART$ADD_COUN,

_mutationTypes.ADD_ADDRESS, function (state, payload) {
  state.myAddress.push(payload);
}), _defineProperty(_ADD_TO_CART$ADD_COUN,

_mutationTypes.EDIT_ADDRESS, function (state, payload) {
  var foo = state.myAddress.find(function (item) {
    return item.timeID == payload.timeID;
  });
  foo = payload;
}), _defineProperty(_ADD_TO_CART$ADD_COUN,

_mutationTypes.CHANGE_DEFAULT, function (state, payload) {
  if (payload.isDefault) {
    console.log(111);
    var foo = state.myAddress.filter(function (item) {
      return item.timeID != payload.timeID;
    });
...
_mutationTypes.DEL_ADDRESS, function (state, payload) {
  state.myAddress = state.myAddress.filter(function (item) {
    return item.timeID != payload.timeID;
  });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.DEL_ADDRESS = exports.CHANGE_DEFAULT = exports.EDIT_ADDRESS = exports.ADD_ADDRESS = exports.DEL_COLLECT = exports.COLLECT_GOOD = exports.DELETE_GOOD = exports.CHANGE_COUNT = exports.CHANGE_SELECTED = exports.ADD_COUNT = exports.ADD_TO_CART = void 0;var ADD_TO_CART = 'add_to_cart';exports.ADD_TO_CART = ADD_TO_CART;
var ADD_COUNT = 'add_count';exports.ADD_COUNT = ADD_COUNT;
var CHANGE_SELECTED = 'change_selected';exports.CHANGE_SELECTED = CHANGE_SELECTED;
var CHANGE_COUNT = 'change_count';exports.CHANGE_COUNT = CHANGE_COUNT;
var DELETE_GOOD = 'delete_good';exports.DELETE_GOOD = DELETE_GOOD;
var COLLECT_GOOD = 'collect_good';exports.COLLECT_GOOD = COLLECT_GOOD;
var DEL_COLLECT = 'del_collect';exports.DEL_COLLECT = DEL_COLLECT;
var ADD_ADDRESS = 'add_address';exports.ADD_ADDRESS = ADD_ADDRESS;
var EDIT_ADDRESS = 'edit_address';exports.EDIT_ADDRESS = EDIT_ADDRESS;
var CHANGE_DEFAULT = 'change_default';exports.CHANGE_DEFAULT = CHANGE_DEFAULT;
var DEL_ADDRESS = 'del_address';exports.DEL_ADDRESS = DEL_ADDRESS;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _mutationTypes = __webpack_require__(/*! ./mutation-types */ 15);var _default =
...

{
  ...
  addToCart: function addToCart(context, payload) {
    return new Promise(function (resolve, reject) {
      ...
      if (oldProduct) {
        context.commit(_mutationTypes.ADD_COUNT, [oldProduct, payload.count]);
  ...
  // 改变选中状态
  changeSelected: function changeSelected(context, payload) {
    return new Promise(function (resolve, reject) {
      var oldStaus = context.state.cartList.find(function (item) {
        return item.size === payload.size && item.style === payload.style;
      });
      context.commit(_mutationTypes.CHANGE_SELECTED, oldStaus);
      resolve('选中状态已改变');
    });
  },
  // 改变购物车中商品数量
  changeCount: function changeCount(context, payload) {
    return new Promise(function (resolve, reject) {
      context.commit(_mutationTypes.CHANGE_COUNT, payload);
      resolve('商品数量已改变');
    });
  },
  // 删除选中商品
  deleteGood: function deleteGood(context) {
    return new Promise(function (resolve, reject) {
      context.commit(_mutationTypes.DELETE_GOOD);
      resolve('已删除选中商品');
    });
  },
  // 收藏商品
  collectGood: function collectGood(context, payload) {
    return new Promise(function (resolve, reject) {
      context.commit(_mutationTypes.COLLECT_GOOD, payload);
      resolve('收藏成功');
    });
  },
  // 取消收藏
  delCollect: function delCollect(context) {
    return new Promise(function (resolve, reject) {
      context.commit(_mutationTypes.DEL_COLLECT);
      resolve('取消收藏成功');
    });
  },
  // 添加地址
  addAddress: function addAddress(context, payload) {
    return new Promise(function (resolve, reject) {
      if (payload.isDefault) {
        for (var i = 0, len = context.state.myAddress.length; i < len; i++) {
          context.state.myAddress[i].isDefault = false;
        }
      }
      context.commit(_mutationTypes.ADD_ADDRESS, payload);
      resolve('添加地址成功');
    });
  },
  // 修改地址
  editAddress: function editAddress(context, payload) {
    return new Promise(function (resolve, reject) {
      if (payload.isDefault) {
        var foo = context.state.myAddress.filter(function (item) {
          return item.timeID != payload.timeID;
        });
      ...
      context.commit(_mutationTypes.EDIT_ADDRESS, payload);
      resolve('修改地址成功');
    });
  },
  // 改变默认地址
  changeDefault: function changeDefault(context, payload) {
    return new Promise(function (resolve, reject) {
      context.commit(_mutationTypes.CHANGE_DEFAULT, payload);
      resolve('设置成功');
    });
  },
  // 删除地址
  delAdd: function delAdd(context, payload) {
    return new Promise(function (resolve, reject) {
      context.commit(_mutationTypes.DEL_ADDRESS, payload);
      resolve('删除成功');
    });
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  cartListCount: function cartListCount(state, getters) {
    return getters.cartList.length;
  },
  collGoodList: function collGoodList(state) {
    return state.collList;
  },
  collGoodCount: function collGoodCount(state, getters) {
    return getters.collGoodList.length;
  },
  addList: function addList(state) {
    return state.myAddress;
  },
  addDetail: function addDetail(state, getters) {
    return function (id) {
      return getters.addList.find(function (item) {
